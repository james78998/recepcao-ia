      ...
      <main className="flex-1 p-8">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <section className="bg-white rounded-2xl shadow p-6">
            ...
            <div className="space-y-4">
              <input className="w-full border p-3 rounded-xl" placeholder="Modelo da IA" defaultValue="gpt-4o-mini" />
              <input className="w-full border p-3 rounded-xl" placeholder="Temperatura" defaultValue="0.4" />
              <textarea
          ...
          <section className="bg-white rounded-2xl shadow p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <input className="border p-3 rounded-xl" placeholder="Segunda a sexta - início" defaultValue="08:00" />
              <input className="border p-3 rounded-xl" placeholder="Segunda a sexta - fim" defaultValue="18:00" />
              <input className="border p-3 rounded-xl" placeholder="Sábado - início" defaultValue="08:00" />
              <input className="border p-3 rounded-xl" placeholder="Sábado - fim" defaultValue="12:00" />
            </div>
          </section>
        </div>

        <button className="mt-8 bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-4 rounded-xl font-bold">
